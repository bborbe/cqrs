...
var _ = Describe("CommandMessageHandlerTx", func() {
	var ctx context.Context
	var err error
	var schemaID cdb.SchemaID
	var commandMessageHandler libkafka.MessageHandlerTx
	var commandObjectHandler *mocks.CDBCommandObjectHandlerTx
	...
	BeforeEach(func() {
		...
		commandObjectHandler = &mocks.CDBCommandObjectHandlerTx{}
