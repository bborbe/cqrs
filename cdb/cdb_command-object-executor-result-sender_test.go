...
var _ = Describe("CommandObjectExecutorResultSender", func() {
	...
	var err error
	var commandObjectExecutorResultSender cdb.CommandObjectExecutor
	var commandObjectExecutor *libmocks.CDBCommandObjectExecutor
	var resultObjectSender *libmocks.CDBResultObjectSender
	var commandObject cdb.CommandObject
	BeforeEach(func() {
		ctx = context.Background()
		commandObject = cdb.CommandObject{}
		commandObjectExecutor = &libmocks.CDBCommandObjectExecutor{}
	...
	JustBeforeEach(func() {
		commandObjectExecutorResultSender = cdb.NewCommandObjectExecutorResultSender(
	...
	Context("CommandOperation", func() {
		...
		JustBeforeEach(func() {
			id, event, err = commandObjectExecutorResultSender.HandleCommand(ctx, commandObject)
		})
